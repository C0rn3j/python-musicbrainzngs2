...
class UrlTest(unittest.TestCase):
	...
	def testGetRelease(self):
		...
		self.assertEqual(
			"https://musicbrainz.org/ws/2/release/5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b?inc=artists",
			self.opener.get_url(),
		)

		# more than one include
		musicbrainzngs.get_release_by_id(
			"5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b", includes=["artists", "recordings", "artist-credits"]
		)
