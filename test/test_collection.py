...
class CollectionTest(unittest.TestCase):
	...
	def test_auth_required(self):
		...
		ar = musicbrainzngs.musicbrainz._get_auth_type("collection", "foo/releases", [])
		...
		ar = musicbrainzngs.musicbrainz._get_auth_type(
			"artist", "5b11f4ce-a62d-471e-81fc-a69a8278c7da", ["aliases", "user-genres", "artist-rels"]
		)
		self.assertEqual(musicbrainzngs.musicbrainz.AUTH_YES, ar)
	...
	def test_my_collections(self):
		...
		self.assertEqual(musicbrainzngs.musicbrainz.AUTH_YES, params["auth_required"])
	...
	def test_other_collection(self):
		...
		self.assertEqual(musicbrainzngs.musicbrainz.AUTH_IFSET, params["auth_required"])
