...
class CaaTest(unittest.TestCase):
	...
	def test_get_release_group_list(self):
		...
		self.assertEqual(
			"https://coverartarchive.org/release-group/8ec178f4-a8e8-4f22-bcba-1964466ef214", self.opener.myurl
		)
	...
	def test_coverid(self):
		...
		self.assertEqual(
			"https://coverartarchive.org/release/8ec178f4-a8e8-4f22-bcba-1964466ef214/1234", self.opener.myurl
		)
	...
	def test_get_size(self):
		...
		self.assertEqual(
			"https://coverartarchive.org/release/8ec178f4-a8e8-4f22-bcba-1964466ef214/1234-250", self.opener.myurl
		)
		self.assertEqual(resp, res)
	...
	def test_front(self):
		...
		self.assertEqual(
			"https://coverartarchive.org/release/8ec178f4-a8e8-4f22-bcba-1964466ef214/front", self.opener.myurl
		)
		self.assertEqual(resp, res)
	...
	def test_release_group_front(self):
		...
		self.assertEqual(
			"https://coverartarchive.org/release-group/8ec178f4-a8e8-4f22-bcba-1964466ef214/front", self.opener.myurl
		)
		self.assertEqual(resp, res)
	...
	def test_back(self):
		...
		self.assertEqual(
			"https://coverartarchive.org/release/8ec178f4-a8e8-4f22-bcba-1964466ef214/back", self.opener.myurl
		)
		self.assertEqual(resp, res)
